...
const GUIDE_SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      {
        title: "＋ تصميم جديد بمقاسات وقوالب جاهزة (Canva Suite)",
        description: "البدء الفوري بمقاسات احترافية لجميع شبكات التواصل الاجتماعي والمطبوعات.",
        steps: [
          "اضغط زر «＋ تصميم جديد» المميز في شريط استوديو الإبداع العلوي",
          "اختر المنصة: إنستغرام، تيك توك، يوتيوب، فيسبوك، لينكد إن، أو سيرة ذاتية وبطاقات عمل",
          "أو أدخل مقاسات مخصصة بالبكسل مع إمكانية قفل نسبة الأبعاد",
          "اختر لون الخلفية الأولية (شفاف، أبيض، أسود، أو لون مخصص) واضغط إنشاء",
        ],
        tip: "تتوفر قوالب جاهزة متعددة الطبقات قابلة للتخصيص الكامل",
      },
      {
        title: "لوحة إدارة المشاريع وسجل الإصدارات (Projects Dashboard)",
        description: "إدارة واستعراض ومشاركة مشاريعك المحفوظة تلقائياً في المتصفح.",
        steps: [
          "اضغط زر «مشاريعي» في شريط الاستوديو العلوي",
          "استعرض بطاقات المشاريع مع معاينة مصغرة وتاريخ آخر تعديل",
          "تكرار المشروع (Duplicate) لتجربة أفكار جديدة دون المساس بالأصل",
          "استعادة المشاريع المحذوفة من سلة المهملات (Trash & Restore)",
          "سجل الإصدارات (Version History) للعودة لنقاط الحفظ السابقة في أي لحظة",
        ],
        tip: "النظام يحفظ عملك تلقائياً كل 30 ثانية في المتصفح دون خوف من فقدان البيانات",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "قص (C) — القص والاقتصاص الاحترافي (Crop & HUD)",
        description: "قص الصورة وتعديل أبعادها مع شبكة قاعدة الأثلاث وبادج الأبعاد اللحظي.",
        steps: [
          "اضغط C لتفعيل أداة القص",
          "يظهر صندوق القص التلقائي مغطياً 90% من الصورة في المنتصف",
          "شبكة قاعدة الأثلاث (Rule of Thirds) تساعدك في موازنة التكوين البصري",
          "مؤشر الأبعاد (HUD Badge) يعرض العرض والارتفاع والإحداثيات لحظياً",
          "اختر من شريط النسب الجاهزة: 1:1 مربع، 16:9 شاشة عريضة، 4:3 كلاسيكي، أو حر",
          "اضغط Enter أو زر التطبيق لتأكيد القص، أو Esc للإلغاء",
        ],
        shortcut: "C | Enter للتطبيق | Esc للإلغاء",
        tip: "يمكن استخدام المقابض الثمانية للتحكم الحر في أبعاد صندوق القص",
      },
      {
        title: "المساطر وخطوط الإرشاد والمحاذاة الذكية (Rulers & Smart Snap)",
        description: "مساطر بكسلية تفاعلية مع خطوط إرشادية ومغنطة تلقائية لمراكز وحواف العناصر.",
        steps: [
          "اضغط Ctrl+R أو من قائمة عرض > إظهار مساطر الأبعاد",
          "اسحب مؤشر الفأرة من المسطرة الأفقية أو الرأسية لإسقاط خط إرشادي في أي موضع",
          "ميزة الالتصاق الذكي (Smart Snap) تنجذب تلقائياً نحو منتصف الصورة والخطوط الإرشادية",
        ],
        shortcut: "Ctrl+R",
      },
      {
  ...
  },
  {
    id: "creative_studio",
    icon: Sparkles,
    title: "المكتبة الإبداعية وصور الستوك والعلامة المائية",
    items: [
      {
        title: "المكتبة الإبداعية الشاملة (Creative Library Hub)",
        description: "مئات الخلفيات الإبداعية المصنفة والأصول والرسومات المتجهة الجاهزة.",
        steps: [
          "اضغط زر «المكتبة الإبداعية» في شريط استوديو الإبداع العلوي",
          "استعرض 17 فئة خلفيات: رخام، خشب، استوديو، فخامة، طبيعة، تقنية، سايبربانك، أزياء، وغيرها",
          "تصفح قسم الرسومات المتجهة (Vector Assets): شارات، أيقونات، ملصقات، وأشكال",
          "انقر لإدراج أي عنصر كطبقة مستقلة أو تعيينه كخلفية للعمل",
        ],
        tip: "تدعم المكتبة الإبداعية السحب والإفلات المباشر نحو الكانفاس (Smart Drop)",
      },
      {
        title: "استوديو العلامة المائية وحماية الحقوق (Watermark Studio)",
        description: "حماية التصاميم والصور الفوتوغرافية بعلامة مائية نصية أو شعار مخصص.",
        steps: [
          "اضغط زر «العلامة المائية» في الشريط الجانبي أو شريط القوائم",
          "اختر نوع العلامة: نص مخصص أو صورة شعار (Logo)",
          "اضبط الشفافية والعتامة لتظهر العلامة بأناقة دون حجب التفاصيل",
          "حدد الموضع (في الزوايا أو المنتصف) أو فعّل النمط التكراري المائل (Tile Pattern)",
          "اضغط تطبيق لتثبيت العلامة المائية على التصميم",
        ],
        tip: "النمط التكراري الشبكي يمنع سرقة أو اقتصاص الصور المنشورة على الإنترنت",
      },
      {
        title: "استوديو الدمج والمزج الاحترافي (Blend Studio)",
        description: "دمج صورتين ومزج الطبقات وفق معادلات المزج الرياضية.",
        steps: [
          "اضغط زر «دمج صورتين» في الشريط الجانبي أو شريط الإبداع",
          "ارفع الصورة الثانية المراد دمجها مع الصورة الحالية",
          "اختر وضع المزج: عادي، مضاعفة (Multiply)، شاشة (Screen)، أو تراكب (Overlay)",
          "اضبط نسبة التلاشي والشفافية وعاين النتيجة مباشرة قبل التطبيق",
        ],
      },
      {
        title: "التصدير متعدد المقاسات لشبكات التواصل (Multi-Size Export)",
        description: "تصدير حزمة كاملة لجميع منصات التواصل الاجتماعي بضغطة زر واحدة.",
        steps: [
          "من قائمة ملف > تصدير متعدد المقاسات (Social Media Pack)",
          "يقوم النظام آلياً بتحجيم تصميمك لكافة مقاسات المنصات (Story, Post, Cover, Banner)",
          "تنزيل جميع المقاسات دفعة واحدة في ملف مضغوط ZIP عالي الجودة",
        ],
        tip: "يوفر ساعات من العمل اليدوي في إعادة تحجيم التصاميم",
      },
    ],
  },
  {
